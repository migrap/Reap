...
namespace Reap {
    public class ExtensionObject : IExtensionCollection {
        ...
        public void SetInterface(Type type, object extension) {
        ...
        public bool ContainsKey(Type key) {
            return key.GetType().IsAssignableFrom(_instance.GetType().GetType());
        }
        ...
        public bool TryGetValue(Type key, out object value) {
            return (value = GetInterface(key)) != null;
        }
